...
export const interceptAllCharacters = () => {
  cy.intercept("GET", "/api/characters", characters).as("characters");
};

export const interceptStudents = () => {
  cy.intercept(
    "GET",
    "/api/characters/students",
    characters.filter((c) => c.hogwartsStudent)
  ).as("students");
};

export const interceptStaff = () => {
  cy.intercept(
    "GET",
    "/api/characters/staff",
    characters.filter((c) => c.hogwartsStaff)
  ).as("staff");
};

export const interceptCharacter = (id: string) => {
  cy.intercept("GET", `/api/character/${id}`, [
